...
An English video by the creator of the mod going through this readme is available here: https://youtu.be/tR15sfybaDc
----------------------------------------------------------------------------------------------------
Installation Instructions (Read very carefully):
1. Extract and move the contents of this folder to the root folder / directory of the Monstrum game on your computer. This is where the .exe file of the game is located. You can access this via Steam by clicking on the settings of the game and choosing "Browse local files".
...
Additionally, there is a video with German text specific to installing the mod available here: https://www.youtube.com/watch?v=7BIdnt0dPiw
...
- Untick the box for "MonstrumExtendedSettingsMod" while running the Partiality Launcher and press "Apply Mods & Patches" [New] / "Apply Mods" [Old] at the bottom of the window.
----------------------------------------------------------------------------------------------------
...
1. Access the Steam settings for Monstrum and click "VERIFY INTEGRITY OF GAME FILES..." under Properties/LOCAL FILES.
2. Remove the folders from the mod or those created by Partiality from Monstrum's root folder / directory. These are:
- "ModDependencies"
- "Mods"
- "PartialityHashes"
3. Delete the "Managed" folder inside of "Monstrum_Data". Rename "Managed_backup" in the same folder to "Managed".
4. Remove the files from the mod or those created by Partiality from Monstrum's root folder / directory. These are:
- "appid"
- "consoleLog"
- "exceptionLog"
- "modSettings"
5. Uninstall Partiality by deleting the folder you created for it.
6. Delete the PartialityLauncher and Monstrum Extended Settings Mod zip files you downloaded if not deleted already.
...
If you wish to talk more about the mod you can join Team Junkfish's Discord server (the creators of Monstrum) at http://discord.gg/Junkfish and talk about it in the channel #monstrum-modded. This is also where in development versions are frequently posted.
Additionally, if you wish to find out more about the mod's development, its code, or want to help in a more direct way, you can join the Discord server dedicated to the mod at http://discord.com/invite/q5kSyd3 . This server is not very active though and the Junkfish server is used more.
...
Please contact the creator of the mod on Discord at Precipitator#5613.
You can do this either by adding them as a friend or by joining Team Junkfish's Discord server (the creators of Monstrum) at http://discord.gg/Junkfish and reporting the bug in the channel #monstrum-modded . Of course the mod's dedicated server can also be used for this purpose.
...
IMPORTANT: Please do not contact any of the other people on the credits list for reporting bugs or getting help as they offered specialised assistance with development of the mod and do not know very much about how it works.
----------------------------------------------------------------------------------------------------
Credits:
- Precipitator#5613 - Creator / Developer of the mod.
- DevilNaiden#3379 - Early help through discussion about modding the game as well as motivation to develop the mod.
...
- bee#2660 - Creating advanced code to help with specific problems related to Partiality modding.
